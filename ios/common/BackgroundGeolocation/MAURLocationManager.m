...
-(void)onTick:(NSTimer *)timer {
   CLLocation * lastKnownLocation  = [locationManager location];
    CLLocation * faked = [[CLLocation alloc] initWithLatitude: lastKnownLocation.coordinate.latitude longitude:lastKnownLocation.coordinate.longitude];
   NSArray *locations = @[faked];
    NSLog(@"timer tick");
